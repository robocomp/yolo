...
/** \mainpage RoboComp::yoloDSR
 *
 * \section intro_sec Introduction
 *
 * The yoloDSR component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/yoloDSR --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class yoloDSR : public RoboComp::Application
{
public:
	yoloDSR (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::yoloDSR::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::yoloDSR app(prefix, startup_check_flag);
