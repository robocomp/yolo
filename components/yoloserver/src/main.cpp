...
/** \mainpage RoboComp::yoloserver
 *
 * \section intro_sec Introduction
 *
 * The yoloserver component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/yoloserver --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class yoloserver : public RoboComp::Application
{
public:
	yoloserver (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::yoloserver::run(int argc, char* argv[])
{
	QCoreApplication a(argc, argv);  // NON-GUI application

	std::cout << "SHIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIT" << std::endl;
