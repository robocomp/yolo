...
void init_detector(char  *datacfg, char *cfgfile, char *weightfile, char *filename, float thresh, float hier_thresh, char *outfile, int fullscreen) {
    cuda_set_device(0);
...
void run_detector(int argc, char **argv)
{
    ...
    image im;
    if(0==strcmp(argv[2], "test")) test_detector(thresh, hier_thresh, outfile, fullscreen,im);
